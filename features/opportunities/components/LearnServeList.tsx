...
export default function LearnServeList() {
  ...
  useEffect(() => {
    const handlePageChange = () => {
      const topElement = document.getElementById(scrollToTopId);
      if (topElement) {
        topElement.scrollIntoView({ behavior: "smooth", block: "start" });
      }
    };

    window.addEventListener("learn-serve-page-change", handlePageChange);
    return () => {
      window.removeEventListener("learn-serve-page-change", handlePageChange);
    };
  }, []);
  ...
  return (
    <>
      ...
      <div className="border-t border-[#000] opp-itm-shadow">
        <div className="2xl:px-5 px-3 mobilescreen:px-[13px] 2xl:w-[75%] laptopmain:w-[83%] laptop:w-[78%] laptopitm:w-[85%] lg:w-[90%] md:w-[85%] w-[90%] py-[40px] mx-auto 2xl:py-[70px] laptopmain:py-[50px] laptop:py-[40px] lg:py-[40px] mobilescreen:py-[40px] relative">
          <div id={scrollToTopId}></div>
          <PlacementBanner placement="development" />
          ...
          <div className="2xl:pt-[70px] laptopmain:pt-[50px] laptop:pt-[40px] pt-[40px] dotlist-white horizontal_scroll">
            <h1 className="flex">
              <Title text={t("COMMON.LEARN_SHARE")} variant="cyan" className="setpadding !mb-7" />
            </h1>
