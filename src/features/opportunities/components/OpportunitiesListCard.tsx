...
import OpportunityCard, { getOpportunityAccent } from "./OpportunityCard";
...
// A local copy of `formatDateRange` used to live here, duplicating the one in
// lib/helpers.ts. OpportunityCard renders the date strip now, so it is gone.
