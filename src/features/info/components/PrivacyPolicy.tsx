...
/**
 * Static, translated privacy policy — the fallback used when the CMS has no
 * published `privacy` page (`GET /pages/privacy/` returns 404). Ported from
 * the legacy React app (`fursa_frontend/src/components/PrivacyPolicy.tsx`).
 */
      ...
      <div className="2xl:px-5 px-3 mobilescreen:px-[13px] 2xl:w-[75%] laptopmain:w-[83%] laptop:w-[78%] laptopitm:w-[85%] lg:w-[90%] md:w-[85%] w-[90%] mx-auto relative 2xl:py-[70px] laptopmain:py-[50px] laptop:py-[40px] lg:py-[40px] mobilescreen:py-[40px] py-[40px]">
        ...
        <section className="mb-5">
          <h2 className="text-[25px] mobilescreen:text-2xl font-bold text-[#29246d] mb-5 mobilescreen:mb-4">
            1. {t("PRIVACY.DATA_WE_COLLECT")}
          </h2>

          <div className="mb-4">
            <h3 className="text-[20px] mobilescreen:text-lg font-semibold text-[#29246d] mb-3">
              {t("PRIVACY.SUBSECTION_A")} {t("PRIVACY.DATA_PROVIDED_DIRECTLY")}
            </h3>
          ...
          <div className="mb-4">
            <h3 className="text-[20px] mobilescreen:text-lg font-semibold text-[#29246d] mb-3">
              {t("PRIVACY.SUBSECTION_B")} {t("PRIVACY.DATA_COLLECTED_AUTOMATICALLY")}
            </h3>
            <ul className="list-disc pl-7 rtl:pr-7 space-y-2 text-secondary-100 lg:text-lg md:text-base mobilescreen:text-xs font-normal">
        ...
        {/* 8. Advertising & Promotional Content */}
        <section className="mb-5">
          <h2 className="text-[25px] mobilescreen:text-2xl font-bold text-[#29246d] mb-5 mobilescreen:mb-4">
            8. {t("PRIVACY.ADVERTISING_PROMOTIONAL")}
          </h2>
          <ul className="list-disc pl-7 rtl:pr-7 space-y-2 text-secondary-100 lg:text-lg md:text-base mobilescreen:text-xs font-normal">
        ...
        <section className="mb-5">
          <h2 className="text-[25px] mobilescreen:text-2xl font-bold text-[#29246d] mb-5 mobilescreen:mb-4">
            9. {t("PRIVACY.PHOTOS_MEDIA")}
          </h2>
          <p className="text-secondary-100 lg:text-lg md:text-base mobilescreen:text-xs font-normal mb-3">
            {t("PRIVACY.PHOTOS_MEDIA_INTRO")}
          </p>
